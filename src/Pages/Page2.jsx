    ...
    return (
        <div className="section2 text-center p-10">
            ...
            {!isMobile && (
                <>
                    <div>
                        <h1 className="text-[40vw] font-[portfolio] uppercase leading-[35vw]">The future</h1>
                    </div>
                    <div>
                        <h1 className="text-[40vw] font-[portfolio] uppercase leading-[35vw]">isn’t</h1>
                    </div>
                    <div>
                        <h1 className="text-[40vw] font-[portfolio] uppercase leading-[35vw]">written</h1>
                    </div>
                    <div>
                        <h1 className="text-[40vw] font-[portfolio] uppercase leading-[35vw]">it’s</h1>
                    </div>
                    <div>
                        <h1 className="text-[40vw] font-[portfolio] uppercase leading-[35vw]">coded.</h1>
                    </div>
                </>
            )}
        </div>
